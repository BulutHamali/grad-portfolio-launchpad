...
const Hero = () => {
  ...
  return (
    ...
    <section id="top" className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-900 via-blue-900 to-slate-800 text-white relative overflow-hidden">
      {/* Background Pattern */}
        ...
        <div className="animate-fade-in">
          ...
          <div className="mb-4">
            <span className="inline-block bg-gradient-to-r from-cyan-400 to-blue-400 text-slate-900 px-4 py-2 rounded-full text-sm font-semibold">
              Cloud &amp; AI Engineer | Computational Biologist
            </span>
          </div>
          ...
          <p className="text-xl md:text-2xl mb-4 text-slate-300">
            Cloud-native AI engineer with deep roots in computational biology
          </p>
          <p className="text-lg mb-6 text-slate-400 max-w-3xl mx-auto">
            I architect cloud infrastructure for AI/ML and bioinformatics workloads.
            PhD in Biochemistry, Nextflow Ambassador, based in Cincinnati, OH.
            {/* TODO: verify — add "AWS-certified" once SAA exam is passed */}
          </p>
          ...
          <div className="flex justify-center space-x-6 mb-20">
            <a href="https://github.com/BulutHamali" target="_blank" rel="noopener noreferrer" className="text-slate-400 hover:text-blue-400 transition-colors">
              <Github size={24} />
            </a>
